    ...
    case "GET":
      try {
        ...
        switch (query.scope) {
          ...
          case "shipping":
              const shippingData = pageData.shippingPage;
              res.status(200).json({ success: true, page: shippingData, settings });
              break;

              
          case "contact":
            const contactData = pageData.contactPage;
            res.status(200).json({ success: true, page: contactData, settings });
            break;
