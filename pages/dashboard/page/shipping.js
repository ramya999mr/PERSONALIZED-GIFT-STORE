...
const ShippingPageSetup = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await postData(`/api/page?scope=shipping`, {
        content: editorState,
      });
      response.success
...
ShippingPageSetup.requireAuthAdmin = true;
ShippingPageSetup.dashboard = true;

export default ShippingPageSetup;
